...
export const se6Assembly = await defineAssemblyDraft({
  ...
  obstacleVolumes: [cylinderVolumeMm("upper-arm-cable-corridor", 14, 360, [210, 0, 340])],
  accessVolumes: [[30, -45], [30, 45], [390, -45], [390, 45]].map(([x, y], index) =>
    cylinderVolumeMm(`upper-arm-fastener-access-${index + 1}`, 5, 110, [x!, y!, 340])),
