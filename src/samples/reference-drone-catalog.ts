...
const definitions = [
  ...
  { ...common, id: "board-stack-mount", category: "fastener", manufacturer: "Sunderlabs", partNumber: "M3-OPEN30-STACK-REV1", provenance: provenance(["openFcProduct", "openEscProduct", "body"], [["board mount pitch", 30.5, "mm", "openFcProduct"], ["board through holes", 4, "mm", "openEscProduct"], ["through bolt", "M3 x 25", "mm", "body"], ["lower spacer", 6.835, "mm", "body"], ["inter-board spacer", 4.145, "mm", "body"]], "The 30.5 mm pattern, 4 mm board holes, and board envelopes are published OpenDrone interfaces. Bolt, custom spacer, and locknut dimensions fit the placed STEP bounds but require production supplier qualification."), mass: kg(0.0015), massAccounting: "standalone", optimizationRole: "fixed-component", centerOfMass: point(0, 0, 0.011), anchor: anchor("frame-bearing-plane"), envelope: cylinder("board-stack-mount-envelope", [0, 0, 0.01105], 0.003, 0.0281), collisionVolumes: [cylinder("board-stack-mount-collision", [0, 0, 0.01105], 0.003, 0.0281)], protectedVolumes: [], mountInterfaces: [], geometry: { kind: "parametric", graph: BOARD_STACK_MOUNT_GRAPH }, interfaces: [semantic("mate", "frame-through-hole", [0, 0, 0], { mating: "concentric", diameter: m(0.0034) }), semantic("mate", "openesc-bearing-plane", [0, 0, 0.006835], { mating: "planar" }), semantic("mate", "openfc-bearing-plane", [0, 0, 0.01731], { mating: "planar" })] },
