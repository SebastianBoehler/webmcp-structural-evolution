...
const mount = (id: string, position: readonly [number, number, number], diameter: number) => ({
  id, position: point(...position), orientation: zeroOrientation, diameter: m(diameter), fastenerType: "M3",
});
...
const definitions = [
  ...
  { ...common, id: "motor-wiring-corridor", category: "wiring", manufacturer: "Sunderlabs", partNumber: "3x20AWG-CORRIDOR-REV1", provenance: provenance(["hobbywing", "speedybee"], [["motor leads", "3x 20AWG", "wire", "hobbywing"], ["published lead length", 150, "mm", "hobbywing"], ["routing corridor", "184 x 6 x 6", "mm", "speedybee"]], "The 6 mm corridor is a conservative routing allowance and carries no independent mass."), mass: kg(0), massAccounting: "none", optimizationRole: "protected", centerOfMass: point(0, 0, 0), anchor: anchor("corridor-center"), envelope: box("wiring-envelope", [0, 0, 0], [0.184, 0.006, 0.006]), collisionVolumes: [box("wiring-collision", [0, 0, 0], [0.184, 0.006, 0.006])], protectedVolumes: [box("keepout", [0, 0, 0], [0.184, 0.006, 0.006])], mountInterfaces: [], geometry: { kind: "parametric", graph: WIRING_GRAPH }, interfaces: [semantic("cable", "wire-route", [0, 0, 0], { connector: "3x 20AWG motor leads" })] },
