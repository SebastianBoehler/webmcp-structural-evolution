  ...
  return {
    ...
    result: {
      ...
      analysis: {
        ...
        cases: {
          "collective-thrust": { displacement: field([0.001, 0.002]), displacementVectorsM: field([0, 0, -0.001, 0, 0, -0.002]), stress: field([8_000_000, 9_000_000]) },
          "roll-differential": { displacement: field([0.002, 0.003]), displacementVectorsM: field([0, 0, -0.002, 0, 0, 0.003]), stress: field([10_000_000, 12_000_000]) },
          "pitch-differential": { displacement: field([0.003, 0.004]), displacementVectorsM: field([0, 0, -0.003, 0, 0, 0.004]), stress: field([14_000_000, 16_000_000]) },
          "yaw-torsion": { displacement: field([0.001, 0.0015]), displacementVectorsM: field([0, 0.001, 0, 0, -0.0015, 0]), stress: field([6_000_000, 7_000_000]) },
        },
      },
    },
  };
