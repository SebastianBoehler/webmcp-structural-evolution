...
- The public video starts from the already selected reference drone; approved assembly
  switching may still be shown elsewhere, but it is not the primary production path.
